...
output_dir = home+"/research_ua/icecube/Upgrade/timing_calibration/data/"
...
def main():
    ...
    cmdParser.add_argument(dest="meas_name",
                           help="measurement name in verical")
    ...
    for n, doc in enumerate(docs):
        ...
        deggdir = output_dir +f"degg_{args.meas_name}/" + degg
