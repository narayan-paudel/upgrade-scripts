...
cmdParser.add_argument('-meas_name', '--meas_name',type=str, dest='meas_name', 
                       help='meas_name to grab from verical')
...
for idom in deployed_degg_list[:]:
    ...
    subprocess.call(f"python get_degg_linearity_current.py {idom} {args.meas_name}",shell=True)
